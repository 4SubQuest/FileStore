...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7082313030:AAEPJ_trIElHxPhOUO_v-9t65QArEk16sBI")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002081959062"))
...
#start message
START_MSG = os.environ.get("START_MESSAGE", "<b>ʜᴇʟʟᴏ {first}\n\n I ᴀᴍ Cᴀᴛ Bᴜʀɢʟᴀʀ Nᴀᴍɪ , I Cᴀɴ Pʀᴏᴠɪᴅᴇ Aɴɪᴍᴇ Fɪʟᴇs Iғ Yᴏᴜ Jᴏɪɴ AɴɪᴍᴇQᴜᴇsᴛ Cʜᴀɴɴᴀʟs » </b>")
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "5364178811").split()):
        ADMINS.append(int(x))
except ValueError:
        raise Exception("Your Admins list does not contain valid integers.")

#Force sub message 
FORCE_MSG = os.environ.get("FORCE_SUB_MESSAGE", "Wʜʏ Yᴏᴜ Dɪᴅɴ'ᴛ Jᴏɪɴᴇᴅ Aʟʟ Oғ Aɴɪᴍᴇ Qᴜᴇsᴛ Cʜᴀɴɴᴀʟs ? Jᴏɪɴ Aʟʟ Oғ Tʜᴇᴍ Tʜʀɴ Tʀʏ Aɢᴀɪɴ !")
